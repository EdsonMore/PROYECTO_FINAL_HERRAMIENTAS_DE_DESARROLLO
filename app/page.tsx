...
export default function HomePage() {
  const session = null; // Auth disabled
  return (
      ...
      <main className="flex-1">
            ...
            {!session && (
              <div className="mt-6">
                <Link href="/registro">
                  <Button
                    size="lg"
                    className="bg-[color:var(--color-primary)] hover:bg-[color:var(--primary-700)] text-white"
                  >
                    Comienza ahora
                  </Button>
                </Link>
        ...
        <section className="hero-section relative py-12 md:py-24 px-4">
            ...
            <div className="hero-grid grid grid-cols-1 lg:grid-cols-[1fr_520px] gap-6 items-center">
              <div className="text-center lg:text-left hero-left flex flex-col justify-center lg:pr-12 lg:pl-4">
                ...
                <p className="mt-4 text-lg md:text-xl text-muted-foreground text-pretty max-w-3xl">
                  Registra, cuida y sigue el crecimiento de tus árboles
                  plantados. Comparte su evolución con fotos y aprende los
                  mejores consejos de cuidado.
                </p>
                ...
                {!session ? (
                  <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
                    <Link href="/registro">
                      <Button
                        size="lg"
                        className="w-full sm:w-auto bg-[color:var(--primary-600)] hover:bg-[color:var(--primary-700)] text-white rounded-lg px-6 py-3 shadow-lg flex items-center gap-3"
                      >
                        <Sprout className="h-4 w-4" />
                        Comenzar Ahora
                      </Button>
          ...
          <div className="hero-wave" aria-hidden="true">
            ...
            >
              <path
                d="M0,40 C300,140 1100,-20 1440,60 L1440,120 L0,120 Z"
                fill="var(--background)"
              />
            </svg>
          </div>
            ...
            <div className="mt-6 md:mt-8 lg:mt-10">
              <div className="w-full mx-auto bg-white rounded-3xl shadow-2xl p-6 md:p-8 relative z-10 max-w-none px-6 lg:px-20">
                <div className="flex flex-col md:flex-row items-stretch gap-6 md:gap-0 divide-y md:divide-y-0 md:divide-x divide-gray-100">
                  <div
                    className="flex-1 flex items-start gap-4 py-6 px-6 bg-white rounded-lg hover:shadow-lg transition-shadow feature-card delay-0"
                    style={{
                      animationDelay: "80ms",
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">
                        Añade los detalles de tu árbol plantado fácilmente.
                      </p>
                    </div>
                  </div>

                  <div
                    className="flex-1 flex items-start gap-4 py-6 px-6 bg-white rounded-lg hover:shadow-lg transition-shadow feature-card delay-1"
                    style={{
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">
                        Sube fotos y observa su evolución con el tiempo.
                      </p>
                    </div>
                  </div>

                  <div
                    className="flex-1 flex items-start gap-4 py-6 px-6 bg-white rounded-lg hover:shadow-lg transition-shadow feature-card delay-2"
                    style={{
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">
                        Monitorea su crecimiento y recibe recomendaciones.
                      </p>
                    </div>
                  </div>

                  <div
                    className="flex-1 flex items-start gap-4 py-6 px-6 bg-white rounded-lg hover:shadow-lg transition-shadow feature-card delay-3"
                    style={{
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">
                        Inspira a otros compartiendo tu impacto ambiental.
                      </p>
                    </div>
                  </div>
                </div>
